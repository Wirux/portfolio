    ...
    <div>
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-200 bg-sky-950'>
            <a className='flex justify-between items-center w-full text-sky-200' href='www.google.com'>
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-200 bg-green-950'>
            <a className='flex justify-between items-center w-full text-sky-200' href='https://github.com/Wirux'>
      ...
      <div className='lg:hidden max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full bg-[#0a192f]' >
        ...
        <div className='w-full grid grid-cols-2 gap-4 text-center py-6 '>
          ...
          <a className='shadow-md shadow-[#040c16] hover:scale-110 hover:shadow-pink-950 duration-300 flex flex-col items-center justify-center text-center text-green-700'>
            <FaGithub size={40} />
            <p>GitHub</p>
          </a>
          <a className='shadow-md shadow-[#040c16] hover:scale-110 hover:shadow-pink-950 duration-300 flex flex-col items-center justify-center text-center text-purple-700' href='google.com'>
