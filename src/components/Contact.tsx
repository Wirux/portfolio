...
function Contact() {
  return (
    <div data-name='contact' className='w-full bg-[#0a192f] flex justify-center items-center p-4 py-8'>
      <form method='POST' action='https://getform.io/f/53c8701b-522a-4a17-a3c9-1149cc2900d6' className='flex flex-col max-w-[600px] w-full'>
        ...
        <button className='text-gray-400 px-4 py-4 my-8 mx-auto bg-gradient-to-b from-transparent to-pink-700 hover:from-pink-700/10 hover:scale-110 hover:to-pink-700 duration-300 '>Let's Collaborate</button>
      </form>
    </div>
  )
}
